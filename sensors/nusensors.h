...
#define SENSORS_DEVICE_NAME	     "/dev/sensor"
#define ACCELEROMETER_DEVICE_NAME   SENSORS_DEVICE_NAME
...
/* BMA 220 defines */
#define BMA220_ACC_IOCTL_BASE			'a'
/* The following define the IOCTL command values via the ioctl macros */
#define BMA220_ACC_IOCTL_SET_DELAY		_IOW(BMA220_ACC_IOCTL_BASE, 0, int)
#define BMA220_ACC_IOCTL_GET_DELAY		_IOR(BMA220_ACC_IOCTL_BASE, 1, int)
#define BMA220_ACC_IOCTL_SET_ENABLE		_IOW(BMA220_ACC_IOCTL_BASE, 2, int)
#define BMA220_ACC_IOCTL_GET_ENABLE		_IOR(BMA220_ACC_IOCTL_BASE, 3, int)
#define BMA220_ACC_IOCTL_SET_G_RANGE		_IOW(BMA220_ACC_IOCTL_BASE, 4, int)
