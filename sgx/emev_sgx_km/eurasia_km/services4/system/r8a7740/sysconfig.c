...
static PVRSRV_ERROR SysLocateDevices(SYS_DATA *psSysData)
{
	...
	eError = OSBaseAllocContigMemory(SYS_R8A7740_SGX_REGS_SIZE, 
									 &gsSGXRegsCPUVAddr,
									 &sCpuPAddr);
	if(eError != PVRSRV_OK)
	{
	...
	gsSGXDeviceMap.ui32RegsSize = SYS_R8A7740_SGX_REGS_SIZE;
	...
	OSMemSet(gsSGXRegsCPUVAddr, 0, SYS_R8A7740_SGX_REGS_SIZE);
	...
	gsSGXDeviceMap.sRegsSysPBase.uiAddr = SYS_R8A7740_SGX_REGS_SYS_PHYS_BASE;
	gsSGXDeviceMap.sRegsCpuPBase = SysSysPAddrToCpuPAddr(gsSGXDeviceMap.sRegsSysPBase);
	gsSGXDeviceMap.ui32RegsSize = SYS_R8A7740_SGX_REGS_SIZE;

	gsSGXDeviceMap.ui32IRQ = SYS_R8A7740_SGX_IRQ;
...
PVRSRV_ERROR SysDeinitialise (SYS_DATA *psSysData)
{
	...
	if(SYS_SPECIFIC_DATA_TEST(gpsSysSpecificData, SYS_SPECIFIC_DATA_ENABLE_LOCATEDEV))
	{
		...
		OSBaseFreeContigMemory(SYS_R8A7740_SGX_REGS_SIZE, gsSGXRegsCPUVAddr, gsSGXDeviceMap.sRegsCpuPBase);
	}
#endif
