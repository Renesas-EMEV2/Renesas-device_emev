...
static PVRSRV_ERROR SysLocateDevices(SYS_DATA *psSysData)
{
	...
	eError = OSBaseAllocContigMemory(SYS_R8A73A00_SGX_REGS_SIZE,
									 &gsSGXRegsCPUVAddr,
									 &sCpuPAddr);
	if(eError != PVRSRV_OK)
	{
	...
	gsSGXDeviceMap.ui32RegsSize = SYS_R8A73A00_SGX_REGS_SIZE;
	...
	OSMemSet(gsSGXRegsCPUVAddr, 0, SYS_R8A73A00_SGX_REGS_SIZE);
	...
	gsSGXDeviceMap.sRegsSysPBase.uiAddr =
		SYS_R8A73A00_SGX_REGS_SYS_PHYS_BASE;
	gsSGXDeviceMap.sRegsCpuPBase = SysSysPAddrToCpuPAddr(gsSGXDeviceMap.sRegsSysPBase);
	gsSGXDeviceMap.ui32RegsSize = SYS_R8A73A00_SGX_REGS_SIZE;

	gsSGXDeviceMap.ui32IRQ = SYS_R8A73A00_SGX_IRQ;
...
IMG_CHAR *SysCreateVersionString(IMG_CPU_PHYADDR sRegRegion)
{
	...
	pvRegsLinAddr = OSMapPhysToLin(sRegRegion, SYS_R8A73A00_SGX_REGS_SIZE,
